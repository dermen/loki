...
for set_key in cluster_set_keys:
    ...
    for ll in unique_labels:
        ...
        if streak_masks is None:
            diff_norm, pairing=pair_diff_PI(norm_shots, 
                mask_ac, qs,
                qidx_pair = qidx, 
                pair_method=args.pair_metric)
